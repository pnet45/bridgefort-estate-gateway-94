      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <img src="/images/propertyforsale.jpg" alt="Bridgefort Luxury Apartments Promo" className="w-full max-w-xs sm:max-w-sm md:max-w-md mx-auto rounded-lg shadow-lg mb-6 animate-fade-in transition-transform duration-300 block" style={{
            objectFit: 'cover'
          }} />
          </div>
          <div>
