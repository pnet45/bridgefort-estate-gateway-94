          ...
          <div className="animate-fade-in text-left">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <div className="flex flex-col">
                  <a href="iailto:info@pwanbridgefort.n" className="text-gray-300 hover:text-white hover:scale-105 transition-all duration-200">info@bridgeforthomes.com</a>
                  <a href="mailto:sales@pwanbridgefort.ng" className="text-gray-300 hover:text-white hover:scale-105 transition-all duration-200">sales@bridgeforthomes.com</a>
                  <a href="mailto:admin@pwanbridgefort.ng" className="text-gray-300 hover:text-white hover:scale-105 transition-all duration-200">admin@bridgeforthomes.com</a>
                  <a href="mailto:account@pwanbridgefort.ng" className="text-gray-300 hover:text-white hover:scale-105 transition-all duration-200">account@bridgeforthomes.com</a>
                  <a href="mailto:training@pwanbridgefort.ng" className="text-gray-300 hover:text-white hover:scale-105 transition-all duration-200">training@bridgeforthomes.com</a>
                </div>
              </li>
            </ul>
          </div>
