      ...
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            At Bridgefort Homes Development Ltd, we're not just selling properties—we're building legacies and helping you achieve financial freedom. Making home ownership dream a reality.
          </p>
        </div>
