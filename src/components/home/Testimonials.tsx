...
const testimonials = [
  {
    name: 'Solomon Oike',
    role: 'PBO and Property Investor',
  ...
  },
  {
    ...
    testimonial: 'I purchased a commercial property through PWAN Bridgefort and the return on investment has been incredible. Their market knowledge is outstanding and excellent service delivery.',
    rating: 4,
