...
const InvestmentServices = () => {
  ...
  return <section className="section-padding py-[38px]">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {services.map((service, idx) => <div key={service.title} className="opacity-0 bg-estate-blue p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 text-center transform" ref={el => cardsRef.current[idx] = el} style={{
          ...
          transitionDelay: `${idx * 50}ms`
              ...
              <Link to={service.link} className={`text-white font-medium hover:text-gray-200 flex items-center justify-center transition-colors
