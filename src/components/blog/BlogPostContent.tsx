...
const BlogPostContent: React.FC<BlogPostContentProps> = ({ htmlContent }) => {
  ...
  if (!html || html.length < 300) {
    html = `
      <p>
        <img src="/lovable-uploads/e96b32e6-88d0-4155-8c87-cbe499a239d3.png" alt="Summit Event" class="rounded-lg w-full md:w-2/3 mx-auto mb-6 shadow-md" loading="lazy" />
      ...
      <img src="/lovable-uploads/8038c999-40e2-49bf-afec-2cb0b5bc2c14.png" alt="Estate Tour" class="rounded-lg w-full md:w-2/3 mx-auto my-7 shadow-md" loading="lazy" />
      ...
      <img src="/lovable-uploads/796b8bc3-c103-4ea9-bc00-f5ccc19ab812.png" alt="Real Estate Training" class="rounded-lg w-full md:w-2/3 mx-auto my-7 shadow-md" loading="lazy" />
