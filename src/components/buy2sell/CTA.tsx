  ...
  return (
    <section className="py-16 bg-estate-blue text-white text-center">
      <div className="container-custom">
        <h2 className="text-3xl font-bold mb-4">Ready to Start Land Trading with Buy to Sell?</h2>
        <p className="text-xl mb-8 max-w-2xl mx-auto">Start your journey to guaranteed land trading profit today. Our team is ready to assist you.</p>
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link to="/services" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-estate-blue font-medium text-lg px-8 py-3 rounded transition duration-300">
            View All Land Trading Services
          </Link>
        </div>
      </div>
    </section>
