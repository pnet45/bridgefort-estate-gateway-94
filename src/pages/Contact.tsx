...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md h-full">
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    <a href="https://facebook.com" className="bg-estate-blue text-white p-2 rounded-full hover:bg-estate-darkBlue transition duration-300">
      ...
      <a 
        href="https://wa.me/2348030624059" 
        target="_blank" 
