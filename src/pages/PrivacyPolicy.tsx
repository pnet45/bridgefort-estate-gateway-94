      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="container-custom">
          <div className="bg-white rounded-lg shadow-md p-6 md:p-10">
            ...
            <section className="mb-8" id="google-oauth">
              <h2 className="text-2xl font-bold mb-4">Google Sign-In & Third-Party Authentication</h2>
              <p className="mb-4">
                Bridgefort Homes Development Ltd offers "Sign in with Google" as a convenient way to access your
                account. This section explains exactly what data we access, why, and how it is handled —
                in accordance with Google's API Services User Data Policy and Nigeria's Data Protection Act (NDPA).
              </p>
              <h3 className="text-xl font-semibold mb-2">What We Access</h3>
              <p className="mb-4">
                When you choose to sign in with Google, we request access to the following scopes only:
              </p>
              <ul className="list-disc pl-6 mb-4 space-y-1">
                <li><strong>Email address</strong> — to identify your account, send transactional emails (purchase confirmations, payment receipts, event registrations), and for account recovery.</li>
                <li><strong>Basic profile (name)</strong> — to personalise your dashboard, contracts, and communications.</li>
              </ul>
              <p className="mb-4">
                We do <strong>not</strong> request or access your Google Drive, Gmail, Contacts, Calendar, Photos,
                or any other Google service beyond the basic profile and email listed above.
              </p>
              <h3 className="text-xl font-semibold mb-2">Why We Need It</h3>
              <p className="mb-4">
                The data received from Google is used solely to:
              </p>
              <ul className="list-disc pl-6 mb-4 space-y-1">
                <li>Create and uniquely identify your Bridgefort Homes account</li>
                <li>Send important transactional notifications related to your property purchases, payments, and registrations</li>
                <li>Personalise your experience on the platform</li>
                <li>Enable secure, passwordless account access</li>
              </ul>
              <p className="mb-4">
                We do <strong>not</strong> use your Google data for advertising, profiling, or any purpose
                beyond what is described above. We do not sell, share, or transfer your Google account data
                to any third party except where required for the services you have explicitly requested
                (e.g., payment processing).
              </p>
              <h3 className="text-xl font-semibold mb-2">Data Storage & Security</h3>
              <p className="mb-4">
                Data received from Google is stored securely in our Supabase-hosted database, protected by
                row-level security, encryption at rest, and strict access controls. Only authorised staff
                with a verified business need may access your data.
              </p>
              <h3 className="text-xl font-semibold mb-2">Revoking Access</h3>
              <p className="mb-4">
                You may revoke Bridgefort Homes' access to your Google account at any time by visiting
                your <a href="https://myaccount.google.com/permissions" target="_blank" rel="noopener noreferrer" className="text-estate-blue hover:underline">Google Account Permissions</a> page
                and removing Bridgefort Homes. You may also use email/password sign-in as an alternative at any time.
                To request deletion of your account data, contact{' '}
                <a href="mailto:dpo@bridgeforthomes.com" className="text-estate-blue hover:underline">dpo@bridgeforthomes.com</a>.
              </p>
              <p className="mb-4">
                Our use of information received from Google APIs adheres to the{' '}
                <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer" className="text-estate-blue hover:underline">
