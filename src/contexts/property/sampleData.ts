...
export const sampleProperties: Property[] = [
  ...
  {
    id: 'luxury-3bedroom-rental-lagos',
    name: 'Executive 3-Bedroom Rental Lagos',
    title: 'Luxury 3-Bedroom Apartment for Rent in VI',
    location: 'Victoria Island, Lagos',
    ...
    description: 'Executive 3-bedroom apartment in the heart of Victoria Island. Fully furnished with luxury finishes, ocean view, and premium location.',
    features: ['3 Bedrooms', '3 Bathrooms', 'Ocean View', 'Luxury Finishes', 'Fully Furnished'],
    amenities: ['Concierge Service', 'Swimming Pool', 'Gym', 'Parking', '24/7 Security'],
    paymentPlans: ['Monthly: ₦600,000', 'Quarterly: ₦1,700,000', 'Annual: ₦6,000,000']
  },
  {
    id: 'affordable-rental-asaba',
    name: 'Affordable 1-Bedroom Rental Asaba',
    ...
    description: 'Comfortable 1-bedroom apartment in GRA Asaba. Perfect for young professionals and small families. Clean, secure, and affordable.',
    features: ['1 Bedroom', '1 Bathroom', 'Kitchen', 'Living Room', 'Secure'],
    amenities: ['Good Road Network', 'Electricity', 'Water Supply', 'Security'],
    paymentPlans: ['Monthly: ₦120,000', 'Quarterly: ₦350,000', 'Annual: ₦1,200,000']
  },
  {
    id: 'luxury-rental-ogun',
