...
export const locations: LocationData[] = [
  ...
  },
  {
    ...
    heroTitle: 'Land for Sale in Abuja, FCT',
    metaTitle: 'Land for Sale in Abuja, FCT | Bridgefort Homes',
    metaDescription: 'Verified estate land for sale in Abuja, FCT. Titled plots in Lugbe, Kuje, Gwagwalada, Karshi and Kubwa corridors with flexible payment plans.',
    intro: 'Abuja, Nigeria\'s capital, combines federal-government stability with some of the country\'s strongest land appreciation. Bridgefort offers verified, titled plots across Abuja\'s key satellite-town growth corridors.',
    whyInvest: [
      'Federal capital with sustained government infrastructure spending',
      'Stable demand from civil servants, Diaspora and corporate tenants',
      'Satellite towns offer Lagos-style ROI at lower entry prices',
      'Premium rental yields in serviced districts',
    ],
    popularEstates: ['Lugbe Axis', 'Kuje Corridor', 'Gwagwalada', 'Karshi', 'Kubwa Extension'],
    nearbyCommunities: ['Lugbe', 'Kuje', 'Gwagwalada', 'Karshi', 'Kubwa', 'Nyanya'],
    priceRange: '₦2M – ₦30M per plot',
    roiNote: 'Satellite-town plots typically appreciate 18–25% annually as FCT expands outward.',
    faqs: [
      { q: 'Is land in Abuja satellite towns titled?', a: 'Bridgefort Abuja estates come with Deed of Assignment, Survey Plan and (where applicable) R of O or C of O.' },
      { q: 'Which Abuja area gives the best ROI?', a: 'Lugbe, Kuje and Karshi currently offer the best entry-to-appreciation ratio in the FCT.' },
    ],
  },
  {
    slug: 'imo-state',
    ...
    state: 'Imo State',
    region: 'South-East Nigeria',
    heroTitle: 'Land for Sale in Imo State',
    metaTitle: 'Land for Sale in Imo State | Bridgefort Homes',
    metaDescription: 'Verified estate land for sale across Imo State — Owerri, Mbaise, Orlu, Okigwe and Mbaitoli corridors with flexible payment plans.',
    intro: 'Imo State is the cultural and commercial heart of the South-East, with Owerri as its capital and strong Diaspora-driven property demand across Mbaise, Orlu and Okigwe. Bridgefort offers verified plots in Imo\'s prime expansion corridors.',
    whyInvest: [
      'Strong Diaspora and South-East returnee demand',
      'Lower entry prices than Lagos with comparable appreciation',
      'Owerri capital-city growth spilling into surrounding LGAs',
      'Cultural & lifestyle hub of the South-East',
    ],
    popularEstates: ['New Owerri', 'Mbaise Road Corridor', 'Orlu Axis', 'Okigwe', 'Mbaitoli'],
    nearbyCommunities: ['Owerri', 'Mbaise', 'Orlu', 'Okigwe', 'Mbaitoli', 'Nekede'],
    priceRange: '₦1M – ₦8M per plot',
    roiNote: 'Steady 12–20% annual appreciation driven by Diaspora returnee investment.',
    faqs: [
      { q: 'Which part of Imo State is best for investment?', a: 'Owerri (the capital), Mbaise and Orlu currently lead Imo State for land appreciation and rental demand.' },
    ],
  },
  {
    slug: 'anambra-state',
    ...
    state: 'Anambra State',
    region: 'South-East Nigeria',
    heroTitle: 'Land for Sale in Anambra State',
    metaTitle: 'Land for Sale in Anambra State | Bridgefort Homes',
    metaDescription: 'Verified estate land for sale across Anambra State — Awka, Onitsha, Nnewi and Ihiala corridors with flexible payment plans.',
    intro: 'Anambra State is the commercial powerhouse of the South-East, anchored by Onitsha\'s trading hub, Nnewi\'s industrial belt, and Awka the state capital. Bridgefort offers verified, titled plots across Anambra\'s prime corridors.',
    whyInvest: [
      'Onitsha — one of West Africa\'s largest commercial markets',
      'Nnewi industrial cluster driving workforce housing demand',
      'Strong Diaspora investment from the South-East',
      'Active state-government infrastructure expansion around Awka',
    ],
    popularEstates: ['Awka Capital Axis', 'Onitsha-Owerri Road', 'Nnewi Industrial Corridor', 'Ihiala'],
    nearbyCommunities: ['Awka', 'Onitsha', 'Nnewi', 'Ihiala', 'Nkpor', 'Obosi'],
    priceRange: '₦1.5M – ₦12M per plot',
    roiNote: 'Commercial-corridor plots near Onitsha and Nnewi deliver 15–22% annual appreciation.',
    faqs: [
      { q: 'Where is the best place to buy land in Anambra?', a: 'Awka, the Onitsha-Owerri corridor and Nnewi are currently the strongest investment zones in Anambra State.' },
    ],
  },
];
