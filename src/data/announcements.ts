...
export const announcementItems: AnnouncementItem[] = [
  {
    ...
    fullContent: `
      <h2>Bridgefort Homes Development Ltd Delivers Again: Successful Land Allocation & Possession at Ode-Omi Estates</h2>
      ...
      <p><em>"I am truly impressed. Seeing my plot physically today gives me so much confidence. Bridgefort Homes Development Ltd has proven to be a company that keeps its word."</em> – <strong>Mr. Adebayo</strong></p>
      ...
      <p><strong>At Bridgefort Homes Development Ltd, we don't just sell land — we deliver value, security, and a future you can build on.</strong></p>
  ...
  },
  {
    ...
    fullContent: `
      <h2>Bridgefort Homes Development Ltd Celebrates Customer Service Week with Exciting Value-Driven Activities</h2>
  ...
  },
  {
    ...
    fullContent: `
      ...
      <p>Bridgefort Homes Development Ltd is expanding and we are looking for talented individuals to join our dynamic team!</p>
...
export const getAnnouncementById = (id: string) =>
  announcementItems.find((a) => a.id === id);
