export const valentineBlogPost = {
  ...
  content: `
    <div class="blog-post-content">
      ...
      <blockquote class="border-l-4 border-red-500 pl-4 italic my-6 text-lg">
      ...
      <p>But what if this year, you chose to gift something that <strong>grows in value</strong>? Something that says, "I love you enough to invest in your future"?</p>

      <h3>🏡 Why Land Is the Ultimate Valentine Gift</h3>
      <p>Real estate — particularly land — is one of the few assets that consistently <strong>appreciates over time</strong>. Unlike material gifts, land:</p>
      <ul>
        <li>✅ <strong>Never depreciates</strong> — It only increases in value year after year</li>
        <li>✅ <strong>Generates wealth</strong> — You can build on it, lease it, or resell at profit</li>
        <li>✅ <strong>Secures the future</strong> — It's a legacy for your children and generations to come</li>
        <li>✅ <strong>Shows deep love</strong> — Gifting land tells someone, "I care about your tomorrow, not just today"</li>
        <li>✅ <strong>Protects against inflation</strong> — While cash loses value, land gains value</li>
      </ul>

      <h3>🎯 Assets vs. Liabilities: Know the Difference</h3>
      <p>In the words of financial experts, <strong>an asset puts money in your pocket; a liability takes money out</strong>. This Valentine, make the conscious decision to gift assets:</p>

      <table class="w-full my-6 border-collapse">
        <thead>
          <tr class="bg-red-50">
            <th class="border p-3 text-left">❌ Liabilities (Lose Value)</th>
            <th class="border p-3 text-left">✅ Assets (Gain Value)</th>
          </tr>
        </thead>
        <tbody>
          <tr><td class="border p-3">Designer clothes & accessories</td><td class="border p-3">A plot of land in a prime estate</td></tr>
          <tr><td class="border p-3">Expensive dinner at a restaurant</td><td class="border p-3">Investment in a developing property</td></tr>
          <tr><td class="border p-3">Latest smartphone or gadget</td><td class="border p-3">Co-ownership in a real estate project</td></tr>
          <tr><td class="border p-3">Perfumes, chocolates & flowers</td><td class="border p-3">A home or apartment for your loved one</td></tr>
        </tbody>
      </table>
      ...
      <ul>
        ...
        <li>🔹 Surprise your family with a home in a secure estate</li>
        <li>🔹 Begin your children's inheritance with a smart land purchase</li>
      </ul>
      ...
      <ul>
        ...
        <li>🌐 Website: <a href="https://pwanbridgefort.ng" class="text-blue-600 underline">pwanbridgefort.ng</a></li>
      </ul>
