INSERT INTO public.training_events (title, date, time, location, category, capacity, featured, description, image)
VALUES (
  'PWAN Bethel Home Center Seminar with Amb. Dalvin Silva',
  '2026-04-21',
  '11:00 AM',
  'Pwan Bethel Home Center, Okey Bar, 109 Muyibi Street, by Wilmer Bus Stop, Olodi Apapa, Lagos',
  'Center Training',
  '100+',
  true,
